...
const faqData: FAQItem[] = [
  ...
  { title: 'Video: Different Sentence Structures to Improve Writing', content: 'Improve your writing with advanced sentence techniques.' },
  { title: 'IELTS General Facts', content: 'This section covers general facts about the IELTS exam.' },
  { title: 'IELTS Vocabulary', content: 'Important vocabulary lists and usage for IELTS preparation.' },
];
